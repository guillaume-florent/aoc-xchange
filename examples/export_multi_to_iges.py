...
# Export to IGES
filename = aocxchange.utils.path_from_file(__file__, "./models_out/result_export_multi.iges")
my_iges_exporter = aocxchange.iges.IgesExporter(filename, format_="5.3")
